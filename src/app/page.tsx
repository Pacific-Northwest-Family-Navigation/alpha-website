  ...
  return (
    <div className="">
      <p className="text-l text-justify pt-4">
        <h2 className="text-2xl font-bold mb-2">How can you support Pacific Northwest Family Navigation?</h2>
        <p>
          ...
          buy a home from Greg and Kara, they will donate 10% of their
          commission to Pacific Northwest Family Navigation! If you finance with
          Todd, he will give you a free home appraisal worth up to $800. How
          awesome is that? Not only do you get an amazing new home but you get
